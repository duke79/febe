...
# author          :Pulkit Singh
# date            :21/09/2018
# usage           :Instantiate and use like dictionary. Don't forget commit at the end to save modifications (if any),
# 					if not using "with Config()..."
# notes           :-
# python_version  :2.7
# ==============================================================================
...
class Config(dict, metaclass=Singleton):
    ...
    def dump_config_path(self):
        print(self.config_file)


def cli_handler(cmd=None):
    if cmd:
        os.system(cmd + " " + Config().config_file)
    else:
